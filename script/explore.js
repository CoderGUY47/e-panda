      ...
      card.innerHTML = `
                <div class="relative bg-gray-300/50 rounded-xl m-2 p-5 h-64 shrink-0 flex items-center justify-center overflow-hidden">
                    ...
                    <div class="absolute top-4 right-4 flex flex-col gap-2 z-10">
                        ...
                        <button id="wish-${product.id}" class="w-8 h-8 bg-white/60 backdrop-blur-xl border border-white/20 rounded-full flex items-center justify-center text-gray-400 hover:text-red-500 transition-all shadow-sm group/heart">
